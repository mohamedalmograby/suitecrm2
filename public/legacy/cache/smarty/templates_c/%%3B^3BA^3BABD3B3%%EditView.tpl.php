...
"}" class="firstChild" value="{sugar_translate label="<?php echo $this->_tpl_vars['displayParams']['accessKeySelectLabel']; ?>
"}"
onclick='open_popup(
...
<button type="button" name="btn_clr_<?php echo $this->_tpl_vars['idname']; ?>
