<?php /* Smarty version 2.6.31, created on 2021-12-06 11:59:21
         compiled from themes/suite8/include/Dashlets/DashletGenericDisplay.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'themes/suite8/include/Dashlets/DashletGenericDisplay.tpl', 50, false),array('function', 'sugar_translate', 'themes/suite8/include/Dashlets/DashletGenericDisplay.tpl', 61, false),array('function', 'sugar_getimage', 'themes/suite8/include/Dashlets/DashletGenericDisplay.tpl', 66, false),array('function', 'convert_link', 'themes/suite8/include/Dashlets/DashletGenericDisplay.tpl', 111, false),array('function', 'sugar_evalcolumn_old', 'themes/suite8/include/Dashlets/DashletGenericDisplay.tpl', 114, false),array('function', 'sugar_field', 'themes/suite8/include/Dashlets/DashletGenericDisplay.tpl', 116, false),array('modifier', 'default', 'themes/suite8/include/Dashlets/DashletGenericDisplay.tpl', 58, false),array('modifier', 'lower', 'themes/suite8/include/Dashlets/DashletGenericDisplay.tpl', 61, false),)), $this); ?>
...
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('alt_sort', ob_get_contents());ob_end_clean(); ?>
							<span class="sort "title="<?php echo $this->_tpl_vars['alt_sort']; ?>
"><?php echo smarty_function_sugar_getimage(array('name' => 'sort_descend'), $this);?>
</span>
	                    <?php else: ?>
...
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('alt_sort', ob_get_contents());ob_end_clean(); ?>
							<span class="sort" title="<?php echo $this->_tpl_vars['alt_sort']; ?>
"><?php echo smarty_function_sugar_getimage(array('name' => 'sort_ascend'), $this);?>
</span>
							<span class="sort" title="<?php echo $this->_tpl_vars['alt_sort']; ?>
"><?php echo smarty_function_sugar_getimage(array('name' => 'sort_ascend'), $this);?>
</span>
...
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('alt_sort', ob_get_contents());ob_end_clean(); ?>
						<span class="sort" title="<?php echo $this->_tpl_vars['alt_sort']; ?>
"><?php echo smarty_function_sugar_getimage(array('name' => 'sort'), $this);?>
</span>
	                <?php endif; ?>
	           <?php else: ?>
...
?>
			    <?php echo '<td scope=\'row\' align=\''; ?><?php echo ((is_array($_tmp=@$this->_tpl_vars['params']['align'])) ? $this->_run_mod_handler('default', true, $_tmp, 'left') : smarty_modifier_default($_tmp, 'left')); ?><?php echo '\' valign="top" '; ?><?php if (( $this->_tpl_vars['params']['type'] == 'teamset' )): ?><?php echo 'class="nowrap"'; ?><?php endif; ?><?php echo '>'; ?><?php if ($this->_tpl_vars['col'] == 'NAME' || $this->_tpl_vars['params']['bold']): ?><?php echo '<b>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['params']['link'] && ! $this->_tpl_vars['params']['customCode']): ?><?php echo ''; ?><?php ob_start(); ?><?php echo 'index.php?action='; ?><?php echo ((is_array($_tmp=@$this->_tpl_vars['params']['action'])) ? $this->_run_mod_handler('default', true, $_tmp, 'DetailView') : smarty_modifier_default($_tmp, 'DetailView')); ?><?php echo '&module='; ?><?php if ($this->_tpl_vars['params']['dynamic_module']): ?><?php echo ''; ?><?php echo $this->_tpl_vars['rowData'][$this->_tpl_vars['params']['dynamic_module']]; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php echo ((is_array($_tmp=@$this->_tpl_vars['params']['module'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['pageData']['bean']['moduleDir']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['pageData']['bean']['moduleDir'])); ?><?php echo ''; ?><?php endif; ?><?php echo '&record='; ?><?php echo ((is_array($_tmp=@$this->_tpl_vars['rowData'][$this->_tpl_vars['params']['id']])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['rowData']['ID']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['rowData']['ID'])); ?><?php echo '&offset='; ?><?php echo $this->_tpl_vars['pageData']['offsets']['current']+$this->_foreach['rowIteration']['iteration']; ?><?php echo '&stamp='; ?><?php echo $this->_tpl_vars['pageData']['stamp']; ?><?php echo ''; ?><?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('recordUrl', ob_get_contents());ob_end_clean(); ?><?php echo '<'; ?><?php echo ((is_array($_tmp=@$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']][$this->_tpl_vars['params']['ACLTag']])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']]['MAIN']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']]['MAIN'])); ?><?php echo ' href=\''; ?><?php echo smarty_function_convert_link(array('link' => $this->_tpl_vars['recordUrl']), $this);?><?php echo '\'>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['params']['customCode']): ?><?php echo ''; ?><?php echo smarty_function_sugar_evalcolumn_old(array('var' => $this->_tpl_vars['params']['customCode'],'rowData' => $this->_tpl_vars['rowData']), $this);?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php echo smarty_function_sugar_field(array('parentFieldArray' => $this->_tpl_vars['rowData'],'vardef' => $this->_tpl_vars['params'],'displayType' => 'ListView','field' => $this->_tpl_vars['col']), $this);?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if (empty ( $this->_tpl_vars['rowData'][$this->_tpl_vars['col']] ) && empty ( $this->_tpl_vars['params']['customCode'] )): ?><?php echo '&nbsp;'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['params']['link'] && ! $this->_tpl_vars['params']['customCode']): ?><?php echo '</'; ?><?php echo ((is_array($_tmp=@$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']][$this->_tpl_vars['params']['ACLTag']])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']]['MAIN']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']]['MAIN'])); ?><?php echo '>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['col'] == 'NAME' || $this->_tpl_vars['params']['bold']): ?><?php echo '</b>'; ?><?php endif; ?><?php echo '</td>'; ?>
...
<?php $this->_smarty_vars['capture']['tmp1'] = ob_get_contents();  $this->assign('alt_view', ob_get_contents());ob_end_clean(); ?>
					<?php ob_start(); ?>index.php?action=EditView&module=<?php echo $this->_tpl_vars['pageData']['bean']['moduleDir']; ?>
...
&return_module=Home&return_action=index<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('editUrl', ob_get_contents());ob_end_clean(); ?>
                    <a title='<?php echo $this->_tpl_vars['editLinkString']; ?>
' class="list-view-data-icon" href='<?php echo smarty_function_convert_link(array('link' => $this->_tpl_vars['editUrl']), $this);?>
'> <span class="suitepicon suitepicon-action-edit"></span></a>
				<?php endif; ?>
				<?php if ($this->_tpl_vars['pageData']['access']['view']): ?>
					<?php ob_start(); ?>index.php?action=DetailView&module=<?php echo $this->_tpl_vars['pageData']['bean']['moduleDir']; ?>
...
&offset=<?php echo $this->_tpl_vars['pageData']['offsets']['current']+$this->_foreach['rowIteration']['iteration']; ?>
&stamp=<?php echo $this->_tpl_vars['pageData']['stamp']; ?>
&return_module=Home&return_action=index<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('viewUrl', ob_get_contents());ob_end_clean(); ?>
                <a title='<?php echo $this->_tpl_vars['viewLinkString']; ?>
' class="list-view-data-icon" href='<?php echo smarty_function_convert_link(array('link' => $this->_tpl_vars['viewUrl']), $this);?>
' title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_VIEW_INLINE'), $this);?>
...
", false, false, true, $(this).closest("div[id^=pageNum_][id$=_div]").parent().parent())'>
								<span><?php echo smarty_function_sugar_getimage(array('name' => 'paginate_first'), $this);?>
</span>
							</button>
...
", false, false, true, $(this).closest("div[id^=pageNum_][id$=_div]").parent().parent())'>
								<span><?php echo smarty_function_sugar_getimage(array('name' => 'paginate_previous'), $this);?>
</span>
							</button>
...
", false, false, true, $(this).closest("div[id^=pageNum_][id$=_div]").parent().parent())'>
								<span><?php echo smarty_function_sugar_getimage(array('name' => 'paginate_next'), $this);?>
</span>
							</button>
...
", false, false, true, $(this).closest("div[id^=pageNum_][id$=_div]").parent().parent())'>
								<span><?php echo smarty_function_sugar_getimage(array('name' => 'paginate_last'), $this);?>
</span>
							</button>
